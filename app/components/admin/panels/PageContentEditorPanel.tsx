...
import { updatePageContent } from '@/app/lib/actions/admin/page/updatePageContent'
  ...
  return (
    <div className="border border-border-light dark:border-border-dark">
      ...
      >
        ...
        <span className="text-[10px] font-mono tracking-[0.2em] text-muted-light dark:text-muted-dark capitalize">
          {title.replace(/_/g, ' ')}
        </span>
